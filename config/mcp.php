...
return [
    ...
    */
    ...
    // Dynamic client registration is open to anyone, so the redirect target is
    // what limits who can obtain an approval: by default only ChatGPT. Add
    // other MCP clients explicitly, comma-separated, with scheme and host.
    'redirect_domains' => array_values(array_filter(array_map(
        'trim',
        explode(',', (string) env('MCP_REDIRECT_DOMAINS', 'https://chatgpt.com/')),
    ))),
